<?php
    ...
    //--------------------------- TRAITEMENT --------------------------------
        ...
        // 1- Affichage des catégories de Salles :
        ...
        // Affichage des villes 
         ...
         $categories_des_villes = executeRequete("SELECT DISTINCT ville FROM salle");
        $contenu_gauche .= '<div class="list-group">';
            $contenu_gauche .= '<a href="?ville=all" class="list-group-item">Toutes les Villes</a>';

            // Boucle while qui parcourt l'objet $categories_des_villes'


            while($cat = $categories_des_villes->fetch(PDO::FETCH_ASSOC)){
                
                $contenu_gauche .= '<a href="?ville='. $cat['ville'] .'" class="list-group-item">'. $cat['ville'] .'</a>';
            }
        $contenu_gauche .= '</div>';
