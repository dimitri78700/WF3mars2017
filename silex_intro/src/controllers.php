...
/*
 * Name est une variable dans l'url, passée à la fonction anonyme qui sert de 
 * controleur puis à la vue dans la méthode render de twig
 */
...
$app->get('/twig', function () use ($app){
    ...
    // déclaration du controleur en service dans l'application
